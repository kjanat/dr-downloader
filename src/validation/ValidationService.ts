...
export class ValidationService {
   ...
   */
  // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: Comprehensive validation requires checking multiple field types
  static validateRegistrationData(
    ...
    this.validateContextDependentFields(data, errors);
